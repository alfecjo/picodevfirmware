...
### 🌡️ Project 011 — MQTT reads the chip temperature via ADC and publishes it to a Broker, which receives the information and makes it available to subscribers 
